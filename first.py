...
for i in range(10000):
	...
	for iter in input_data:
		...
		res_of_layer_1_1 = segmoid(np.dot(input_data[num_i], weights_1_1)) 
		error_of_layer_1_1 = res_of_layer_1_1 - output_data[num_i]
		weights_1_1_delta.append(get_derivative_of_the_segmoid(res_of_layer_1_1) * error_of_layer_1_1)
		
		res_of_layer_1_2 = segmoid(np.dot(input_data[num_i], weights_1_2)) 
		error_of_layer_1_2 = res_of_layer_1_2 - output_data[num_i]
		weights_1_2_delta.append(get_derivative_of_the_segmoid(res_of_layer_1_2) * error_of_layer_1_2)
	...
	weights_1_2_delta = np.array(weights_1_2_delta) 
	weights_1_2 -= np.dot(input_data.T, weights_1_2_delta)
...
# # weights_1_1_delta = get_derivative_of_the_segmoid(res_of_layer_1_1) * error
